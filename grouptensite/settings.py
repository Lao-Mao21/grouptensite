"""
Django settings for grouptensite project.
...
SECRET_KEY = 'django-insecure-=&9i6xkf-cxislx@u3$33gq$+j(axb(q4jna4n0h2kf1dm5@iu'
...
WSGI_APPLICATION = 'grouptensite.wsgi.application'
